...
Router::connect('/products/:id/to/:catalog_id', array('plugin' => 'Subscription', 'controller' => 'products', 'action' => 'addToCatalog', '[method]' => 'POST'), array('pass' => array('id', 'catalog_id')));
...
Router::connect('/cata;pgs/:id/to/:package_id', array('plugin' => 'Subscription', 'controller' => 'products', 'action' => 'addToPackage', '[method]' => 'POST'), array('pass' => array('id', 'package_id')));
